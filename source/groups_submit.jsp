...
%>
<% 
		message = request.getParameter("post");
		temp = request.getParameter("grouptype");
		if(temp.equals("city")) grouptype = city;
		if(temp.equals("state")) grouptype = state;
		if(temp.equals("work")) grouptype = work; 
		user=(String)session.getAttribute("userid"); 
         ...
         // rs3=st.executeQuery("select * from group where groupname='"+work+"' where count(*)=10 ");
          st.executeUpdate("insert into group values ('"+grouptype+"','"+user+"','"+message+"')");
