...
<center>
<form name="registration" onsubmit="return formValidation();" action="registration_check.jsp" method="POST">
	...
	<td width="100%" height="1">
		...
		<table cellspacing="1" width="100%" border="0" height="240">
			...
			<tr>
				...
				<font size="4">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<marquee width="249" height="22" behavior="alternate" scrollamount="4">
					User Registration
					</marquee>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</font></i></b>
			...
			<tr>
				...
				<td width="63%" height="25"><input name="ambition" size="20" value="<%= request.getParameter("aid") %>"></td>
			</tr>
			<tr>
				<td width="37%" height="25"><b>Email ID</b></td>
				<td width="63%" height="25"><input name="userid" size="20"></td>
			</tr>
			<tr>
			...
			<tr>
				<td width="37%" height="25"><b>Confirm Password</b></td>
				<td width="63%" height="25"><input type="password" name="cpword" size="20"></td>
			</tr>
			<tr>
				<td width="37%" height="25"><b>Phone Number</b></td>
